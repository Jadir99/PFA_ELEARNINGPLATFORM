...
class HomeController extends Controller
{
    ...
    {
        $course = Course::get()->take(5);
        $instructor = Instructor::get();
        // $category = CourseCategory::get();


        #top courses by numbers of subscriptions
        $topCourses = Course::orderBy('num_subscribers', 'desc')
        ->take(5)
        ->get();
        // dd($topCourses);
        #top courses by ratings
        $topCoursesByRating =  Course::orderBy('rating', 'desc')
        ->take(5)
        ->get();
// dd($topCoursesByRating);
        // top 5 categories by numbers of subscriptions
        $category = CourseCategory::all()->take(5);
...
// dd($topInstructors);
        ...
        return view(
            'frontend.home',
            compact('topCourses', 'topCoursesByRating', 'category','course','instructor')
        );
    }
}
