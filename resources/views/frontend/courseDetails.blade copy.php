            ...
            <div class="col-lg-4">
                <div class="icon-with-date d-flex align-items-lg-center">
                    <div class="icon-with-date-start d-flex align-items-center">
                        ...
                        <p class="font-para--md">{{$course->rating}} Star <span>(54,879)</span></p>
                    </div>
                ...
                <div class="icon-with-date d-flex align-items-lg-cente mb-0">
                    <div class="icon-with-date-start d-flex align-items-center">
                        ...
                        <p class="font-para--md">{{$course->num_subscribers}} Enrolled</p>
                    </div>
                    <div class="icon-with-date-end d-flex align-items-center">
                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                        ...
                        <p class="font-para--md">{{$course->num_reviews}} reviews</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="cart">
                        <div class="cart__price">
                            <div class="current-price">
                                <h3 class="font-title--sm">{{$course->type}}</h3>
                            </div>
